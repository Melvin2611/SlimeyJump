...
func _ready():
	...
	# Sammle alle Level-Buttons in Reihenfolge
	...
	# Deaktiviere Buttons für nicht freigeschaltete Levels
	for i in range(buttons.size()):
		var level_index: int = i  # Index beginnt bei 0 für Level 1
		buttons[i].disabled = (level_index > ProgressManager.highest_completed_level)
